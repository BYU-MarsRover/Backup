...
#define PWM_1_TC_STOP_SIGNAL_MODE            (1lu)
#define PWM_1_TC_CAPTURE_SIGNAL_MODE         (1lu)

/* Signal present */
#define PWM_1_TC_RELOAD_SIGNAL_PRESENT       (1lu)
#define PWM_1_TC_COUNT_SIGNAL_PRESENT        (0lu)
#define PWM_1_TC_START_SIGNAL_PRESENT        (1lu)
#define PWM_1_TC_STOP_SIGNAL_PRESENT         (1lu)
#define PWM_1_TC_CAPTURE_SIGNAL_PRESENT      (1lu)

/* Interrupt Mask */
#define PWM_1_TC_INTERRUPT_MASK              (2lu)
