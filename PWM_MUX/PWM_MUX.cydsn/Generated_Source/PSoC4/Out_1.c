...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        Out_1_PC =   (Out_1_PC & \
                                (uint32)(~(uint32)(Out_1_DRIVE_MODE_IND_MASK << (Out_1_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (Out_1_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
{
	SetP4PinDriveMode(Out_1__0__SHIFT, mode);
}
