...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        Out_5_PC =   (Out_5_PC & \
                                (uint32)(~(uint32)(Out_5_DRIVE_MODE_IND_MASK << (Out_5_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (Out_5_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
{
    uint8 drVal = (uint8)(Out_5_DR & (uint8)(~Out_5_MASK));
    drVal = (drVal | ((uint8)(value << Out_5_SHIFT) & Out_5_MASK));
    Out_5_DR = (uint32)drVal;
}
...
{
	SetP4PinDriveMode(Out_5__0__SHIFT, mode);
}
...
{
    return (uint8)((Out_5_PS & Out_5_MASK) >> Out_5_SHIFT);
}
...
{
    return (uint8)((Out_5_DR & Out_5_MASK) >> Out_5_SHIFT);
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		uint8 maskedStatus = (uint8)(Out_5_INTSTAT & Out_5_MASK);
		Out_5_INTSTAT = maskedStatus;
        return maskedStatus >> Out_5_SHIFT;
    }
